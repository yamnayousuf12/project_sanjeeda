...
const AboutCard = () => {
  ...
  title='About us'/>
            <div className='mt-6 space-y-6'>
              {homeAbout.map((val) => (
                <div key={val.title} className='flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 text-black-200'>
                  ...
                  <div className='text-center sm:text-left '>
                    ...
                    <p className='text-black-200'>{val.desc}</p>
                  </div>
                </div>
              ))}
            </div>
